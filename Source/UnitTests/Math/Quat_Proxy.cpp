...
//	B.x /= 1.0f;
	...
	// Should work
	E.x /= 10.0f;
	CHECK( eq(E.x,0.20f,Math::InternalTolerence) );
...
//	B.y /= 1.0f;
	...
	// Should work
	E.y /= 10.0f;
	CHECK( eq(E.y,0.30f,Math::InternalTolerence) );
...
//	B.z /= 1.0f;
	...
	// Should work
	E.z /= 10.0f;
	CHECK( eq(E.z,0.40f,Math::InternalTolerence) );
...
//	B.w /= 1.0f;
	...
	// Should work
	E.w /= 10.0f;
	CHECK( eq(E.w,0.50f,Math::InternalTolerence) );
;
}  
