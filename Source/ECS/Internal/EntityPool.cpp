...
Map<EntityID, Entity*> EntityPool::entityPool;
Map<EntityID, ComponentGroupDescription> EntityPool::entityDescriptions;
Map<EntityID, Array<Component*>> EntityPool::ownedComponentMap;
...
void EntityPool::AttachComponentTo(const Entity& entity, Component& componentToAttach)
{
	...
	entityDescriptions[entity.id].AddComponentWithType(componentToAttach.type);
}

Component* EntityPool::FindComponentOn(const Entity& entity, ComponentType type)
{
	Array<Component*>& compList = ownedComponentMap[entity.id];
