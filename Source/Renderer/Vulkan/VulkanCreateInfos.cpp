...
namespace Vk
{
	VkInstanceCreateInfo InstanceInfo(const tchar ** instanceLayers, uint32 numLayers, const tchar ** instanceExtensions, uint32 numExtensions, const void * additionalData)
	{
	...
	namespace create
	{
		VkImageView ImageView(VulkanDevice * device, VkImage image, VkFormat format, VkImageAspectFlags aspectFlags)
		{
